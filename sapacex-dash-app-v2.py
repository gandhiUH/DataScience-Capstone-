...
\margl1440\margr1440\vieww18880\viewh21600\viewkind0
\deftab720
...
\pard\pardeftab720\partightenfactor0
\cf2 \cb3 \strokec2 #print(spacex_df.head(3))\cf0 \cb1 \strokec4 \
\
...
\cb3                                 \cf7 \strokec7 options\cf0 \strokec4 =[\{\cf6 \strokec6 'label'\cf0 \strokec4 : \cf6 \strokec6 'All Sites'\cf0 \strokec4 , \cf6 \strokec6 'value'\cf0 \strokec4 : \cf6 \strokec6 'ALL'\cf0 \strokec4 \},\cb1 \
...
\cb3                                            \cf7 \strokec7 placeholder\cf0 \strokec4  = \cf6 \strokec6 "Select Launch Site"\cf0 \strokec4 ,\cb1 \
\cb3                                            \cf7 \strokec7 searchable\cf0 \strokec4  = \cf9 \strokec9 True\cf0 \strokec4 ),\cb1 \
\cb3                                 html.Br(),\cb1 \
\
...
\cb3                                 \cf7 \strokec7 min\cf0 \strokec4 =\cf8 \strokec8 0\cf0 \strokec4 ,\cb1 \
\cb3                                 \cf7 \strokec7 max\cf0 \strokec4 =\cf8 \strokec8 10000\cf0 \strokec4 ,\cb1 \
\cb3                                 \cf7 \strokec7 step\cf0 \strokec4 =\cf8 \strokec8 1000\cf0 \strokec4 ,\cb1 \
\cb3                                 \cf7 \strokec7 marks\cf0 \strokec4 =\{\cf8 \strokec8 2500\cf0 \strokec4 : \cf6 \strokec6 '2500'\cf0 \strokec4 , \cf8 \strokec8 5000\cf0 \strokec4 : \cf6 \strokec6 '5000'\cf0 \strokec4 , \cf8 \strokec8 7500\cf0 \strokec4 : \cf6 \strokec6 '7500'\cf0 \strokec4 \},\cb1 \
...
\pard\pardeftab720\partightenfactor0
\cf9 \cb3 \strokec9 def\cf0 \strokec4  \cf10 \strokec10 get_pie_chart\cf0 \strokec4 (\cf7 \strokec7 site\cf0 \strokec4 ):\cb1 \
\pard\pardeftab720\partightenfactor0
\cf0 \cb3     filtered_df = spacex_df\cb1 \
\cb3     data = filtered_df.groupby(\cf6 \strokec6 'Launch Site'\cf0 \strokec4 )[\cf6 \strokec6 'class'\cf0 \strokec4 ].mean().reset_index()\cb1 \
\cb3     \cf2 \strokec2 #print(data.head(3))\cf0 \cb1 \strokec4 \
\cb3     \cf2 \strokec2 #print(site)\cf0 \cb1 \strokec4 \
\cb3     \cf5 \strokec5 if\cf0 \strokec4  site == \cf6 \strokec6 'ALL'\cf0 \strokec4 :\cb1 \
\cb3         \cb1 \
\cb3         fig = px.pie(data, \cf7 \strokec7 values\cf0 \strokec4 =\cf6 \strokec6 'class'\cf0 \strokec4 , \cb1 \
\cb3         \cf7 \strokec7 names\cf0 \strokec4 =\cf6 \strokec6 'Launch Site'\cf0 \strokec4 , \cb1 \
\cb3         \cf7 \strokec7 title\cf0 \strokec4 = \cf9 \strokec9 f\cf6 \strokec6 'Pie Chart of Success Rates of \cf9 \strokec9 \{\cf0 \strokec4 site\cf9 \strokec9 \}\cf6 \strokec6  Sites are Selected'\cf0 \strokec4 )\cb1 \
\cb3         fig.update_traces(\cf7 \strokec7 textfont_size\cf0 \strokec4 =\cf8 \strokec8 20\cf0 \strokec4 ) \cb1 \
...
\cb3         site_data = filtered_df[filtered_df[\cf6 \strokec6 'Launch Site'\cf0 \strokec4 ]==site]\cb1 \
\cb3         success_counts = site_data[\cf6 \strokec6 'class'\cf0 \strokec4 ].value_counts().reset_index()\cb1 \
\cb3         success_counts.columns = [\cf6 \strokec6 'class'\cf0 \strokec4 , \cf6 \strokec6 'count'\cf0 \strokec4 ]\cb1 \
\cb3         \cf2 \strokec2 #print(site)\cf0 \cb1 \strokec4 \
\cb3         fig = px.pie(success_counts, \cf7 \strokec7 values\cf0 \strokec4 =\cf6 \strokec6 'count'\cf0 \strokec4 , \cb1 \
\cb3         \cf7 \strokec7 names\cf0 \strokec4 =\cf6 \strokec6 'class'\cf0 \strokec4 , \cb1 \
\cb3         \cf7 \strokec7 title\cf0 \strokec4 = \cf9 \strokec9 f\cf6 \strokec6 'Pie Chart of Success Rates of \cf9 \strokec9 \{\cf0 \strokec4 site\cf9 \strokec9 \}\cf6 \strokec6  Site is Selected'\cf0 \strokec4 )\cb1 \
\cb3         fig.update_traces(\cf7 \strokec7 textfont_size\cf0 \strokec4 =\cf8 \strokec8 20\cf0 \strokec4 ) \cb1 \
\cb3         \cf5 \strokec5 return\cf0 \strokec4  fig\cb1 \
\
\pard\pardeftab720\partightenfactor0
...
\pard\pardeftab720\partightenfactor0
\cf10 \cb3 \strokec10 @app.callback\cf0 \strokec4 (\cb1 \
\pard\pardeftab720\partightenfactor0
\cf0 \cb3     Output(\cf7 \strokec7 component_id\cf0 \strokec4  =\cf6 \strokec6 "success-payload-scatter-chart"\cf0 \strokec4 , \cf7 \strokec7 component_property\cf0 \strokec4 =\cf6 \strokec6 'figure'\cf0 \strokec4 ),\cb1 \
\cb3     [Input(\cf7 \strokec7 component_id\cf0 \strokec4 =\cf6 \strokec6 'site-dropdown'\cf0 \strokec4 , \cf7 \strokec7 component_property\cf0 \strokec4 =\cf6 \strokec6 'value'\cf0 \strokec4 ),\cb1 \
...
\cb3 )\cb1 \
\pard\pardeftab720\partightenfactor0
\cf9 \cb3 \strokec9 def\cf0 \strokec4  \cf10 \strokec10 update_graph\cf0 \strokec4 (\cf7 \strokec7 site\cf0 \strokec4 , \cf7 \strokec7 payload\cf0 \strokec4 ):\cb1 \
\pard\pardeftab720\partightenfactor0
\cf0 \cb3     \cf2 \strokec2 #print(spacex_df.head(5))\cf0 \cb1 \strokec4 \
\cb3     \cf2 \strokec2 #print(site)\cf0 \cb1 \strokec4 \
\cb3     \cf5 \strokec5 if\cf0 \strokec4  site == \cf6 \strokec6 'ALL'\cf0 \strokec4 :\cb1 \
\cb3         all_df = spacex_df[spacex_df[\cf6 \strokec6 'Payload Mass (kg)'\cf0 \strokec4 ].between(payload[\cf8 \strokec8 0\cf0 \strokec4 ], payload[\cf8 \strokec8 1\cf0 \strokec4 ])]\cb1 \
\cb3         \cf10 \strokec10 print\cf0 \strokec4 (all_df.head(\cf8 \strokec8 3\cf0 \strokec4 ))\cb1 \
\cb3         \cf10 \strokec10 print\cf0 \strokec4 (payload[\cf8 \strokec8 0\cf0 \strokec4 ], payload[\cf8 \strokec8 1\cf0 \strokec4 ])\cb1 \
\cb3         fig2 = px.scatter(all_df, \cf7 \strokec7 x\cf0 \strokec4 =\cf6 \strokec6 'Payload Mass (kg)'\cf0 \strokec4 , \cf7 \strokec7 y\cf0 \strokec4 =\cf6 \strokec6 'class'\cf0 \strokec4 , \cf7 \strokec7 color\cf0 \strokec4 =\cf6 \strokec6 'Booster Version Category'\cf0 \strokec4 ,\cb1 \
\cb3         \cf7 \strokec7 title\cf0 \strokec4 =\cf9 \strokec9 f\cf6 \strokec6 'Correlation Between Payload and Success for \cf9 \strokec9 \{\cf0 \strokec4 site\cf9 \strokec9 \}\cf6 \strokec6  Sites'\cf0 \strokec4 )\cb1 \
\cb3         fig2.update_traces(\cf7 \strokec7 textfont_size\cf0 \strokec4 =\cf8 \strokec8 20\cf0 \strokec4 )\cb1 \
\cb3         \cf5 \strokec5 return\cf0 \strokec4  fig2\cb1 \
\cb3     \cf5 \strokec5 else\cf0 \strokec4 :\cb1 \
\cb3          site_df = spacex_df[spacex_df[\cf6 \strokec6 'Launch Site'\cf0 \strokec4 ]==site]\cb1 \
\
\cb3          fig2 = px.scatter(site_df, \cf7 \strokec7 x\cf0 \strokec4 =\cf6 \strokec6 'Payload Mass (kg)'\cf0 \strokec4 , \cf7 \strokec7 y\cf0 \strokec4 =\cf6 \strokec6 'class'\cf0 \strokec4 , \cf7 \strokec7 color\cf0 \strokec4 =\cf6 \strokec6 'Booster Version Category'\cf0 \strokec4 , \cb1 \
\cb3          \cf7 \strokec7 title\cf0 \strokec4 = \cf9 \strokec9 f\cf6 \strokec6 'Correlation Between Payload and Success for \cf9 \strokec9 \{\cf0 \strokec4 site\cf9 \strokec9 \}\cf6 \strokec6  Site'\cf0 \strokec4 )  \cb1 \
\cb3          fig2.update_traces(\cf7 \strokec7 textfont_size\cf0 \strokec4 =\cf8 \strokec8 20\cf0 \strokec4 ) \cb1 \
\cb3          \cf5 \strokec5 return\cf0 \strokec4  fig2 \cb1 \
\cb3          \cb1 \
\
